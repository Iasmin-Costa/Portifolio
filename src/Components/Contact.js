              ...
              {({ isVisible }) =>
                ...
                <form onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="tel" value={formDetails.phone} placeholder="Número de celular." onChange={(e) => onFormUpdate('phone', e.target.value)}/>
                    </Col>
                    ...
                    </Col>
                    {
                      status.message &&
                      <Col>
                        <p className={status.success === false ? "Tente novamente;/" : "Enviado=)"}>{status.message}</p>
                      </Col>
                    }
                  </Row>
                </form>
